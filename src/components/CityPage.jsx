...
function CityPage() {
  ...
  const fetchNearbyPlaces = (lat, lng) => {
    ...
    fetch(placesUrl, {
      ...
      .catch((error) =>
        setError("Error fetching places data: " + error.message)
      );
  };
      ...
      {cityData ? (
        <>
          <div className="page2">
            ...
            <div className="hidden-text">
              <p>
                Indulge in mouthwatering street food, bursting with authentic
                flavors, local spices, and unforgettable culinary delights.
              </p>
            </div>
          ...
          <div className="page3">
            ...
            <div className="hidden-text">
              <p>
                A breathtaking landmark, rich in history and beauty, offering
                unforgettable experiences and stunning architectural marvels.
              </p>
            </div>
          ...
          <div className="page4">
            ...
            <div className="hidden-text">
              <p>
                Discover unique, handmade treasures at local markets, showcasing
                traditional craftsmanship and authentic cultural artistry.
              </p>
            </div>
            ...
            <div className="hidden-text">
              <p>
                Explore vibrant festivals, food markets, historical tours, art
                exhibitions, and live music to attract curious tourists.
              </p>
            </div>
